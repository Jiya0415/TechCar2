...
from carzone.utils.db import get_db_connection, add_seller, add_car, add_car_image, add_document, DB_PATH
...
from carzone.pages.Estimate import car_makes, locations as locations_estimate
